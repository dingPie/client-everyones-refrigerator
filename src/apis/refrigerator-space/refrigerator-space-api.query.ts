...
export const REFRIGERATOR_SPACE_API_QUERY_KEY = {
  GET_LIST: (params: Parameter<typeof refrigeratorSpaceApi.list>) =>
    ['refrigerator-space-list', params].filter(isNotNull),
  GET_WITH_ITEM_LIST: (
    params: Parameter<typeof refrigeratorSpaceApi.listWithItem>,
...
export function useGetRefrigeratorSpaceListQuery(
  ...
  const queryKey = REFRIGERATOR_SPACE_API_QUERY_KEY.GET_LIST(params.variables);
  return useQuery(
    queryKey,
...
export function useGetRefrigeratorSpaceWithItemListQuery(
  ...
  const queryKey = REFRIGERATOR_SPACE_API_QUERY_KEY.GET_WITH_ITEM_LIST(
    params.variables,
  );
  return useQuery(
    queryKey,
